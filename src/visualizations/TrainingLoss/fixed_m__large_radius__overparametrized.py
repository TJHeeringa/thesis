...
plt.xlabel("Epochs")
plt.ylabel("Loss")
plt.savefig(f"results/images/directApproximation/fixed_m__large_radius__overparametrized.pdf")
...
plt.xlabel("Epochs")
plt.ylabel("Loss")
plt.savefig(f"results/images/taylorApproximation/fixed_m__large_radius__overparametrized.pdf")
plt.show()