...
plt.xlabel("Epochs")
plt.ylabel("Loss")
plt.savefig(f"results/images/directApproximation/fixed_m__small_radius__underparametrized.pdf")
...
plt.xlabel("Epochs")
plt.ylabel("Loss")
plt.savefig(f"results/images/taylorApproximation/fixed_m__small_radius__underparametrized.pdf")
plt.show()